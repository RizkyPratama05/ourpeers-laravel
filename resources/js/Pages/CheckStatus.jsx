...
import { Search, Package, Truck, CheckCircle, Upload, Copy, Check, Image, AlertCircle, RefreshCw } from 'lucide-react';
...
export default function CheckStatus({ order: initialOrder }) {
    ...
    const handleUpload = (e) => {
        ...
        router.post(`/order/${initialOrder.id}/upload-bukti`, formData, {
            ...
            onError: (errors) => {
                setUploading(false);
                alert(errors.bukti_transfer || 'Gagal mengunggah bukti transfer.');
            }
        });
    };
