        ...
        <MainLayout>
                ...
                <div className="container mx-auto grid md:grid-cols-2 gap-16 items-center relative z-10">
                    <div className="space-y-8">
                        <div className="inline-flex items-center gap-2 bg-white/5 border border-white/10 px-4 py-2 rounded-full backdrop-blur-sm">
                            ...
                            <span className="text-brand-lime text-xs font-bold uppercase tracking-widest">Premium Quality Confirmed</span>
                        </div>
                        
                        <h1 className="text-5xl md:text-7xl font-black leading-[1.1] text-white">
                            Eksplorasi <br /> 
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-lime to-lime-300">Konveksi Custom</span> <br /> 
                            Tanpa Batas.
                        </h1>
                        
                        <p className="text-slate-400 text-xl leading-relaxed max-w-lg">
                            Bukan sekadar marketplace. Kami menghadirkan standar produksi pabrikan langsung ke genggaman Anda. Cepat, Presisi, dan Berkualitas.
                        </p>
                        ...
                        <div className="flex flex-wrap gap-4 pt-4">
                            ...
                            >
                                <span className="relative z-10 flex items-center gap-2">
                                    Mulai Pesan <ChevronRight className="group-hover:translate-x-1 transition-transform" />
                                </span>
                            </Link>
                            <Link
                                href="/about"
                        ...
                        <div className="relative z-20 animate-float">
                             <div className="w-full aspect-square bg-gradient-to-br from-white/10 to-transparent rounded-[40px] border border-white/20 backdrop-blur-xl p-8 shadow-2xl">
                                <div className="w-full h-full bg-brand-navy rounded-[30px] flex items-center justify-center border border-white/5 overflow-hidden">
                                     <img src="https://images.unsplash.com/photo-1556905055-8f358a7a47b2?auto=format&fit=crop&q=80&w=800" className="opacity-50 grayscale hover:grayscale-0 transition-all duration-700 hover:scale-110 object-cover w-full h-full" alt="Preview" />
                                </div>
                             </div>
                        </div>
                        {/* Decorative cards */}
            ...
            <section className="py-32 bg-white relative">
                <div className="container mx-auto px-6 text-center">
                    <div className="inline-block px-4 py-1 bg-lime-100 text-brand-lime text-xs font-bold rounded-full mb-4 uppercase tracking-tighter">Our Core Values</div>
                    <h2 className="text-4xl md:text-5xl font-black text-brand-navy mb-4 tracking-tight">
                        Mengapa Memilih Ourpeers?
                    </h2>
                    <p className="text-slate-400 max-w-2xl mx-auto mb-20">Kami menggabungkan teknologi modern dengan craftsmanship tradisional untuk hasil konveksi terbaik.</p>

                    <div className="grid md:grid-cols-3 gap-10 mt-12">
                        {[
                            { icon: <CheckCircle size={40} />, title: 'Custom Tanpa Batas', desc: 'Bebas menentukan bahan, warna, dan detail jahitan sesuai keinginan Anda.' },
                            { icon: <DollarSign size={40} />, title: 'Harga Kompetitif', desc: 'Sistem kalkulasi harga otomatis yang transparan tanpa biaya siluman.' },
                            { icon: <Eye size={40} />, title: 'Kontrol Produksi', desc: 'Pantau setiap tahap produksi pesanan Anda secara real-time dari dashboard.' }
                        ].map((fitur, i) => (
                            <div key={i} className="group p-10 border border-slate-100 rounded-[40px] shadow-[0_20px_50px_rgba(0,0,0,0.02)] bg-white hover:bg-brand-navy transition-all duration-500 hover:-translate-y-4">
            ...
            {/* === PRODUK UNGGULAN === */}
            <section id="produk" className="py-32 bg-slate-50 relative overflow-hidden">
                <div className="container mx-auto px-6">
                    <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
                        <div>
                            <div className="inline-block px-4 py-1 bg-brand-navy text-white text-xs font-bold rounded-full mb-4 uppercase tracking-tighter">Explore Collection</div>
                        ...
                        >
                            Lihat Semua Katalog <div className="p-2 bg-brand-navy text-white rounded-full group-hover:bg-brand-lime group-hover:text-brand-navy transition-all"><ChevronRight size={16} /></div>
                        </Link>
                    </div>
                    ...
                    <div className="grid md:grid-cols-3 gap-10">
                        {products.map((item) => (
                            <div
                                key={item.id}
                                className="group bg-white rounded-[40px] overflow-hidden shadow-[0_30px_60px_rgba(0,0,0,0.05)] hover:shadow-[0_30px_60px_rgba(132,204,22,0.15)] transition-all duration-700 flex flex-col border border-white hover:-translate-y-4"
                            >
                                <div className="h-80 bg-slate-100 overflow-hidden relative">
                                    {item.gambar_url ? (
                                        ...
                                        <div className="w-full h-full flex items-center justify-center text-slate-300 font-bold italic">No Visual</div>
                                    )}
                                ...
                                <div className="p-10 flex flex-col flex-grow relative">
                                    ...
                                    <p className="text-xs text-slate-400 font-bold uppercase tracking-widest mb-6">Price starts from</p>

                                    <div className="flex items-center justify-between mt-auto">
                                        <div className="text-3xl font-black text-brand-navy">
                                            <span className="text-sm font-bold text-slate-300 mr-1">Rp</span>
